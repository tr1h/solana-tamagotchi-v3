...
const AntiCheat = {
    ...
    // Конфигурация
    CONFIG: {
        MAX_XP_PER_ACTION: 50,           // Максимум XP за одно действие (нормально для кликов)
        MAX_TAMA_PER_ACTION: 1000,       // Максимум TAMA за одно действие (1000 для минта!)
        MIN_ACTION_INTERVAL: 50,         // Минимум 0.05 секунды между действиями (как у Notcoin!)
        MAX_LEVEL_PER_SESSION: 10,       // Максимум 10 левелов за сессию (разумно)
        SESSION_DURATION: 3600000,       // 1 час = 1 сессия
        MAX_ABILITY_USES_PER_HOUR: 50,   // Максимум 50 использований способностей в час
