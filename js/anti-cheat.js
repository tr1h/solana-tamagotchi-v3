...
const AntiCheat = {
    ...
    // Конфигурация - МЯГЧЕ ДЛЯ ЛУЧШЕГО ГЕЙМПЛЕЯ! 🎮
    CONFIG: {
        MAX_XP_PER_ACTION: 100,          // Максимум XP за одно действие (в 2 раза больше!)
        MAX_TAMA_PER_ACTION: 2000,       // Максимум TAMA за одно действие (в 2 раза больше!)
        MIN_ACTION_INTERVAL: 25,         // Минимум 0.025 секунды между действиями (в 2 раза быстрее!)
        MAX_LEVEL_PER_SESSION: 20,       // Максимум 20 левелов за сессию (в 2 раза больше!)
        SESSION_DURATION: 3600000,       // 1 час = 1 сессия
        MAX_ABILITY_USES_PER_HOUR: 100,  // Максимум 100 использований способностей в час (в 2 раза больше!)
